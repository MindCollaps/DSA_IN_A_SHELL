...
class Character:
    def __init__(self, name: str):
        ...
        self.base_hp: int = self.spezies.hp_gw + get_leiteigenschaft(self, LeitEigenschaft.KO) + get_leiteigenschaft(self, LeitEigenschaft.KO)
        self.zk: int = self.spezies.zk_gw + int(get_leiteigenschaft(self, LeitEigenschaft.KO) + get_leiteigenschaft(self, LeitEigenschaft.KO) + get_leiteigenschaft(self, LeitEigenschaft.KK) / 6)
