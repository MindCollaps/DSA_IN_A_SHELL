...
class Stone(Item, Consumable):
    def __init__(self):
        super().__init__("Stone", "Limestone is a sedimentary rock primarily composed of calcium carbonate (CaCO3) in the form of the minerals calcite and aragonite", 11, Rarity.COMMON)
